...
// Path utilities
function getLocalPath(serverId, requestedPath) {
...
export async function listDirectory(dirPath, serverId) {
    try {
...
export async function createDirectory(dirPath, serverId) {
    try {
        const localPath = getLocalPath(serverId, dirPath);
...
export async function deleteItem(itemPath, serverId) {
    try {
...
export async function renameItem(oldPath, newPath, serverId) {
    try {
...
export async function createBackup(filePath, serverId) {
    try {
...
export async function readContent(filePath, serverId) {
    try {
        const localPath = getLocalPath(serverId, filePath);
...
export async function writeContent(filePath, content, serverId) {
    try {
        const localPath = getLocalPath(serverId, filePath);
...
export async function upload(targetDir, fileName, fileBuffer, serverId) {
    try {
...
export async function download(filePath, serverId) {
    try {
        const localPath = getLocalPath(serverId, filePath);
...
export async function checkServerFiles(serverId) {
    try {
        const serverDataPath = getServerDataPath(serverId);
...
export async function checkAuth(serverId) {
    try {
        const serverDataPath = getServerDataPath(serverId);
...
export async function wipeData(serverId) {
    try {
        const serverDataPath = getServerDataPath(serverId);
...
export async function copyItem(srcPath, destPath, serverId) {
    try {
