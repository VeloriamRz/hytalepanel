...
export async function cleanupOldBackups(serverId, backupConfig) {
    try {
        ...
        console.error(`[Backups] Cleanup error for ${serverId}:`, e.message);
    }
}
export function startBackupScheduler(serverId, backupConfig) {
...
export function stopBackupScheduler(serverId) {
